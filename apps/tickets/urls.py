...
urlpatterns = [
    ...
    path('issue/create/<int:project_id>/', views.issue_create_view, name='issue_create_view'),
    path('issue/update/<int:issue_id>/', views.issue_update_view, name='issue_update_view'),
